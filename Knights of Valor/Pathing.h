...
public:
	...
	Pathing() {
		...
		GreenArrow[1].Load("pathing\gpright", 1, 1);
		GreenArrow[2].Load("pathing\gpleft", 1, 1);
		GreenArrow[3].Load("pathing\gpup", 1, 1);
		GreenArrow[4].Load("pathing\gpdown", 1, 1);
		GreenArrow[5].Load("pathing\gpup_right", 1, 1);
		GreenArrow[6].Load("pathing\gpup_left", 1, 1);
		GreenArrow[7].Load("pathing\gpdown_right", 1, 1);
		GreenArrow[8].Load("pathing\gpdown_left", 1, 1);

		RedArrow[0].Load("pathing\rpcruce.bmp", 1, 1);
		RedArrow[1].Load("pathing\rpright", 1, 1);
		RedArrow[2].Load("pathing\rpleft", 1, 1);
		RedArrow[3].Load("pathing\rpup", 1, 1);
		RedArrow[4].Load("pathing\rpdown", 1, 1);
		RedArrow[5].Load("pathing\rpup_right", 1, 1);
		RedArrow[6].Load("pathing\rpup_left", 1, 1);
		RedArrow[7].Load("pathing\rpdown_right", 1, 1);
		RedArrow[8].Load("pathing\rpdown_left", 1, 1);
	...
	/*
	void Load_Path(stack<pair<int, int>> path) {
		this->path = path;
	}
	*/
